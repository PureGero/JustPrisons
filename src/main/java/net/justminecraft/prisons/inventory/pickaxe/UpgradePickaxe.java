...
public enum UpgradePickaxe {
    ...
    UpgradePickaxe(String name, String description, ChatColor color) {
        this.name = name;
    ...
    UpgradePickaxe(String name, String description, ChatColor color, Enchantment enchantment) {
        this.name = name;
        this.description = description;
        this.color = color;
    ...
    public static BigInteger getLevel(ItemStack item, UpgradePickaxe upgrade) {
    ...
    public static void setUpgrade(ItemStack item, UpgradePickaxe upgrade, BigInteger level) {
        ItemMeta meta = item.getItemMeta();
