...
public enum UpgradeHelmet {
    ...
    UNBREAKING("Unbreaking", "Increases the durability of the helmet", ChatColor.DARK_BLUE, Enchantment.DURABILITY),
    ...
    UpgradeHelmet(String name, String description, ChatColor color) {
        this.name = name;
    ...
    UpgradeHelmet(String name, String description, ChatColor color, Enchantment enchantment) {
        this.name = name;
        this.description = description;
        this.color = color;
    ...
    public static BigInteger getLevel(ItemStack item, UpgradeHelmet upgrade) {
    ...
    public static void setUpgrade(ItemStack item, UpgradeHelmet upgrade, BigInteger level) {
        ItemMeta meta = item.getItemMeta();
