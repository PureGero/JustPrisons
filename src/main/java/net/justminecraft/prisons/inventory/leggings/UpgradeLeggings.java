...
public enum UpgradeLeggings {
    ...
    UNBREAKING("Unbreaking", "Increases the durability of the leggings", ChatColor.DARK_BLUE, Enchantment.DURABILITY),
    ...
    UpgradeLeggings(String name, String description, ChatColor color) {
        this.name = name;
    ...
    UpgradeLeggings(String name, String description, ChatColor color, Enchantment enchantment) {
        this.name = name;
        this.description = description;
        this.color = color;
    ...
    public static BigInteger getLevel(ItemStack item, UpgradeLeggings upgrade) {
    ...
    public static void setUpgrade(ItemStack item, UpgradeLeggings upgrade, BigInteger level) {
        ItemMeta meta = item.getItemMeta();
